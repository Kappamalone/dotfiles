...
-- Create a signal handler for when client rules are requested.
...
globalkeys = gears.table.join(
    ...
    awful.key({ }, "#122", function () awful.util.spawn("pamixer --allow-boost --set-limit 150 --decrease 5") end),
    awful.key({ }, "#123", function () awful.util.spawn("pamixer --allow-boost --set-limit 150 --increase 5") end),
